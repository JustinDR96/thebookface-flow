...
export default function Pages_Privacy() {
    return (
            ...
            <div className="main_container">
                <div className="main_publication">
                    <div>
                        ...
                        Nous vous encourageons à prendre le temps de lire attentivement ces documents, car ils définissent les bases de votre expérience sur Flow. En choisissant de faire partie de notre communauté, vous acceptez ces conditions et contribuez à créer un environnement numérique positif et enrichissant pour tous.

                        Merci de faire partie de la famille Flow ! ✨
